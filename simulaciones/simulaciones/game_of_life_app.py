...
class GameOfLifeApp:
    ...
    def _styled_button(self, parent, text, cmd, bg="#4361ee", fg="white"):
    ...
    def _g2_toggle(self):
        ...
        if self.g2_running:
            threading.Thread(target=self._g2_loop, daemon=True).start()
